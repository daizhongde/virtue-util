...
//     * @param response
//     */
//    public CustomXWPFDocument getWord(CustomXWPFDocument doc,
//    		 Map<String, Object> params, List<String[]> tableList, String fileName) throws Exception {
////        File file = new File(path);
////        InputStream is = new FileInputStream(file);
////        CustomXWPFDocument doc = new CustomXWPFDocument(POIXMLDocument.openPackage(path));
...
//     * @param response
//     */
//    public CustomXWPFDocument getWord(String path, Map<String, Object> params, List<String[]> tableList, String fileName ) throws Exception {
////        File file = new File(path);
////        InputStream is = new FileInputStream(file);
//        CustomXWPFDocument doc = new CustomXWPFDocument(POIXMLDocument.openPackage(path));
//        this.replaceInPara(doc, params);    //替换文本里面的变量
...
//        
//        if(false){
//        	String email = String.valueOf( params.get("${cEmail}" ) );
//        	appendExternalHyperlink("mailto:"+ email , email,  para );
//
//        }
...
//		            
//				TextSegment found = para.searchText(find,
