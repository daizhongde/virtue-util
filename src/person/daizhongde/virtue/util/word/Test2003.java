...
//		mapList.put("list02", list02);
		...
		WordUtils2003 util = new WordUtils2003();
		HWPFDocument doc = util.getWord("D:/daizd/Desktop/工资/工资清单-非mercer.doc", data, null, null);
		FileOutputStream fopts = new FileOutputStream("D:/呵呵.doc");
		doc.write(fopts);
		fopts.close();
	}
}