...
//					
//				}
				String path =FileUtil1.class.getResource("/").getPath();//得到工程名WEB-INF/classes/路径
...
//				D:\AppData\Workspaces\MyEclipse 2015\message\bin\com\mysoftstone\mq\mdm\xml4test
				...
				if( binIndex != -1 ){
					...
					if(file.indexOf("authority") != -1){
				    	is = FileUtil1.class.getResourceAsStream( "/"+file );
				    }else{
...
//			}
	...
	public static String getFilePath(String file){
			String absPath = "";
			String classpath =FileUtil1.class.getResource("/").getPath();//得到工程名WEB-INF/classes/路径
