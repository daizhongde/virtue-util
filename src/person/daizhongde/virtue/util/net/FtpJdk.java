...
{  
    ...
    {  
        ...
        String filepath[] =  
        { "G_TOBACCO.java", "/temp/regist.log" };  
        String localfilepath[] =  
        { "D:/tmp/1.txt", "C:\\tmp\\2.log" };  
        ...
        try  
        {  
            ftp.connectServer("10.158.240.9", 21, "hadoopadmin", "hadoopadmin123#", "/mnt/disk01/.hadoopadmin/tmp/");  
        ...
        try  
        {  
            ftp.download(filepath[0], localfilepath[0]);  
        } catch (FtpProtocolException e)  
        {  
            e.printStackTrace();  
        }  
